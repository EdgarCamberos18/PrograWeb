...
<head>
    ...
    <?php
        ...
        $datos=consultar_por_id('equipos','ID_EQUIPO',$_GET['Equipo']);
    ?>
    <style>
         #body2{
            background: url('<?php echo$datos->ESTADIO?>');
            height: 90.9vh;
...
<section id="principal"  class="container-fluid slider">
    ...
    <header>
        <h1 class="pt-5 pl-5 pr-5 pb-2"><?php echo utf8_encode($datos->NOMBRE_EQUIPO)?></h1>
    </header>

    <article class="p-5" >
        <div style="text-align:center" >
            <img class="p-5" style="height: 70vh" src="<?php echo utf8_encode($datos->LOGO)?>">
        </div>
        <div class="backG" >
            <h4 class="backG1"><?php echo utf8_encode($datos->INFORMACION)?></h4>
        </div>
    </article>
