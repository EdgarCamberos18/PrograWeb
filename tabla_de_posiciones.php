...
<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse sticky-top ">
    ...
    <a class="navbar-brand" href="index.php">
        <img src="img/logo.jpg" width="30" height="30" class="d-inline-block align-top rounded-circle" alt="Logo de Pagina">
    </a>
...
<section id="principal" class="container-fluid slider">
    ...
    <div class="col-10 offset-1 pt-5" style="opacity: 0.9">
                ...
                <?php
                    ...
                    foreach ($datos as $col) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $col->NOMBRE_EQUIPO ?></td>
                            <td><?php echo $col->P_JUGADOS ?></td>
                            <td><?php echo $col->P_GANADOS ?></td>
                            <td><?php echo $col->P_EMPATADOS ?></td>
                            <td><?php echo $col->P_PERDIDOS ?></td>
                            <td><?php echo $col->G_FAVOR ?></td>
                            <td><?php echo $col->G_CONTRA ?></td>
                            <td><?php echo $col->G_DIFERENCA ?></td>
                            <td><?php echo $col->PUNTOS ?></td>
                        </tr>
                <?php
                    $i++;}
                ?>
